...
abstract class UsersClient {
  ...
  /// [userId] - User ID.
  @GET('/users/{userId}')
  Future<User> getUsersUserId({@Path('userId') required String userId});
  ...
  /// [userId] - User ID.
  @DELETE('/users/{userId}')
  Future<void> deleteUsersUserId({@Path('userId') required String userId});
  ...
  Future<FileUploadResponse> postUsersUserIdAvatar({
