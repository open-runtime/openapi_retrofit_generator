...
mixin _$PaymentResponse {
 ...
 String get transactionId; PaymentResponseStatusStatus get status; double get amount;@JsonKey(includeIfNull: false) DateTime? get processedAt; PaymentResponseDetailsUnion? get details; String get currency;
...
@useResult
$Res call({
 String transactionId, PaymentResponseStatusStatus status, double amount,@JsonKey(includeIfNull: false) DateTime? processedAt, PaymentResponseDetailsUnion? details, String currency
});


$PaymentResponseDetailsUnionCopyWith<$Res>? get details;
...
as PaymentResponseDetailsUnion?,currency: null == currency ? _self.currency : currency // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
/// Create a copy of PaymentResponse
...
$PaymentResponseDetailsUnionCopyWith<$Res>? get details {
  ...
  return $PaymentResponseDetailsUnionCopyWith<$Res>(_self.details!, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String transactionId,  PaymentResponseStatusStatus status,  double amount, @JsonKey(includeIfNull: false)  DateTime? processedAt,  PaymentResponseDetailsUnion? details,  String currency)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaymentResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String transactionId,  PaymentResponseStatusStatus status,  double amount, @JsonKey(includeIfNull: false)  DateTime? processedAt,  PaymentResponseDetailsUnion? details,  String currency)  $default,) {final _that = this;
switch (_that) {
case _PaymentResponse():
return $default(_that.transactionId,_that.status,_that.amount,_that.processedAt,_that.details,_that.currency);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String transactionId,  PaymentResponseStatusStatus status,  double amount, @JsonKey(includeIfNull: false)  DateTime? processedAt,  PaymentResponseDetailsUnion? details,  String currency)?  $default,) {final _that = this;
switch (_that) {
case _PaymentResponse() when $default != null:
return $default(_that.transactionId,_that.status,_that.amount,_that.processedAt,_that.details,_that.currency);case _:
  return null;
...
class _PaymentResponse implements PaymentResponse {
  const _PaymentResponse({required this.transactionId, required this.status, required this.amount, @JsonKey(includeIfNull: false) this.processedAt, this.details, this.currency = 'USD'});
...
@override final  PaymentResponseDetailsUnion? details;
...
@override $PaymentResponseDetailsUnionCopyWith<$Res>? get details;
