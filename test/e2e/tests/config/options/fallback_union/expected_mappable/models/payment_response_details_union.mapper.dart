...
class PaymentResponseDetailsUnionMapper
  ...
  static PaymentResponseDetailsUnionMapper ensureInitialized() {
    if (_instance == null) {
      ...
      PaymentResponseDetailsUnionUnknownMapper.ensureInitialized();
    }
    return _instance!;
  }
...
class PaymentResponseDetailsUnionUnknownMapper
    extends SubClassMapperBase<PaymentResponseDetailsUnionUnknown> {
  PaymentResponseDetailsUnionUnknownMapper._();

  static PaymentResponseDetailsUnionUnknownMapper? _instance;
  static PaymentResponseDetailsUnionUnknownMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = PaymentResponseDetailsUnionUnknownMapper._(),
      );
      PaymentResponseDetailsUnionMapper.ensureInitialized().addSubMapper(
        _instance!,
      );
  ...
  @override
  final String id = 'PaymentResponseDetailsUnionUnknown';

  static Map<String, dynamic> _$json(PaymentResponseDetailsUnionUnknown v) =>
      v.json;
  static const Field<PaymentResponseDetailsUnionUnknown, Map<String, dynamic>>
  _f$json = Field('json', _$json);

  @override
  final MappableFields<PaymentResponseDetailsUnionUnknown> fields = const {
    #json: _f$json,
  };
  ...
  static PaymentResponseDetailsUnionUnknown _instantiate(DecodingData data) {
    return PaymentResponseDetailsUnionUnknown(data.dec(_f$json));
  }

  @override
  final Function instantiate = _instantiate;

  static PaymentResponseDetailsUnionUnknown fromJson(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<PaymentResponseDetailsUnionUnknown>(
      map,
    );
  }

  static PaymentResponseDetailsUnionUnknown fromJsonString(String json) {
    return ensureInitialized().decodeJson<PaymentResponseDetailsUnionUnknown>(
      json,
    );
  }
}

mixin PaymentResponseDetailsUnionUnknownMappable {
  String toJsonString() {
    return PaymentResponseDetailsUnionUnknownMapper.ensureInitialized()
        .encodeJson<PaymentResponseDetailsUnionUnknown>(
          this as PaymentResponseDetailsUnionUnknown,
        );
  }

  Map<String, dynamic> toJson() {
    return PaymentResponseDetailsUnionUnknownMapper.ensureInitialized()
        .encodeMap<PaymentResponseDetailsUnionUnknown>(
          this as PaymentResponseDetailsUnionUnknown,
        );
  }

  PaymentResponseDetailsUnionUnknownCopyWith<
    PaymentResponseDetailsUnionUnknown,
    PaymentResponseDetailsUnionUnknown,
    PaymentResponseDetailsUnionUnknown
  >
  get copyWith =>
      _PaymentResponseDetailsUnionUnknownCopyWithImpl<
        PaymentResponseDetailsUnionUnknown,
        PaymentResponseDetailsUnionUnknown
      >(this as PaymentResponseDetailsUnionUnknown, $identity, $identity);
  @override
  String toString() {
    return PaymentResponseDetailsUnionUnknownMapper.ensureInitialized()
        .stringifyValue(this as PaymentResponseDetailsUnionUnknown);
  }

  @override
  bool operator ==(Object other) {
    return PaymentResponseDetailsUnionUnknownMapper.ensureInitialized()
        .equalsValue(this as PaymentResponseDetailsUnionUnknown, other);
  }

  @override
  int get hashCode {
    return PaymentResponseDetailsUnionUnknownMapper.ensureInitialized()
        .hashValue(this as PaymentResponseDetailsUnionUnknown);
  }
}

extension PaymentResponseDetailsUnionUnknownValueCopy<$R, $Out>
    on ObjectCopyWith<$R, PaymentResponseDetailsUnionUnknown, $Out> {
  PaymentResponseDetailsUnionUnknownCopyWith<
    $R,
    PaymentResponseDetailsUnionUnknown,
    $Out
  >
  get $asPaymentResponseDetailsUnionUnknown => $base.as(
    (v, t, t2) =>
        _PaymentResponseDetailsUnionUnknownCopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class PaymentResponseDetailsUnionUnknownCopyWith<
  $R,
  $In extends PaymentResponseDetailsUnionUnknown,
  $Out
>
    implements PaymentResponseDetailsUnionCopyWith<$R, $In, $Out> {
  ...
  PaymentResponseDetailsUnionUnknownCopyWith<$R2, $In, $Out2>
  $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _PaymentResponseDetailsUnionUnknownCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, PaymentResponseDetailsUnionUnknown, $Out>
    implements
        PaymentResponseDetailsUnionUnknownCopyWith<
          $R,
          PaymentResponseDetailsUnionUnknown,
  ...
  @override
  late final ClassMapperBase<PaymentResponseDetailsUnionUnknown> $mapper =
      PaymentResponseDetailsUnionUnknownMapper.ensureInitialized();
  @override
  MapCopyWith<$R, String, dynamic, ObjectCopyWith<$R, dynamic, dynamic>>
  ...
  @override
  PaymentResponseDetailsUnionUnknown $make(CopyWithData data) =>
      PaymentResponseDetailsUnionUnknown(data.get(#json, or: $value.json));
  ...
  >
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _PaymentResponseDetailsUnionUnknownCopyWithImpl<$R2, $Out2>(
        $value,
        $cast,
        t,
      );
