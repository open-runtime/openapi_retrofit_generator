...
class _AdvancedClient implements AdvancedClient {
  ...
  Future<HttpResponse<PaymentResponse>> createPayment({
    ...
    final _options = _setStreamType<HttpResponse<PaymentResponse>>(
  ...
  @override
  Future<HttpResponse<SearchResponse>> search({SearchRequest? body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<Entity>> getEntity({required String entityId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<Entity>>(
  ...
  @override
  Future<HttpResponse<GetDuplicateResponse>> getDuplicate() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<GetDuplicateResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/conflicts/duplicate',
  ...
  @override
  Future<HttpResponse<dynamic>> createDynamic({
  ...
  @override
  Future<HttpResponse<void>> checkMethods() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<String>> methodsOptions() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
