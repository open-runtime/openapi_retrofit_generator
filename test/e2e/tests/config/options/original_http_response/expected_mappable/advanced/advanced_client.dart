...
abstract class AdvancedClient {
  ...
  @POST('/search')
  Future<HttpResponse<SearchResponse>> search({@Body() SearchRequest? body});
  ...
  Future<HttpResponse<GetDuplicateResponse>> getDuplicate();
  ...
  @HEAD('/methods')
  Future<HttpResponse<void>> checkMethods();

  /// Get allowed methods
  @OPTIONS('/methods')
  Future<HttpResponse<String>> methodsOptions();
}
