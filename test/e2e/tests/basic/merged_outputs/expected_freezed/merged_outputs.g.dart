...
_UserInfoDto _$UserInfoDtoFromJson(Map<String, dynamic> json) =>
    _UserInfoDto(email: json['email'] as String, name: json['name'] as String, phone: json['phone'] as String);

Map<String, dynamic> _$UserInfoDtoToJson(_UserInfoDto instance) => <String, dynamic>{
  'email': instance.email,
  'name': instance.name,
...
class _AuthClient implements AuthClient {
  ...
  @override
  Future<String> postApiAuthRegister({RegisterUserDto? body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'Content-Type': 'text/json'};
...
class _UserClient implements UserClient {
  ...
  @override
  Future<UserInfoDto> getApiUserInfo({List<String>? tags, int? limit}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'tags': tags, r'limit': limit};
    queryParameters.removeWhere((k, v) => v == null);
  ...
  @override
  Future<void> patchApiUserIdAvatar({MultipartFile? avatar, int? id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
