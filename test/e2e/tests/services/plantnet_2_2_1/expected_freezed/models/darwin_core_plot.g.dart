...
_DarwinCorePlot _$DarwinCorePlotFromJson(Map<String, dynamic> json) => _DarwinCorePlot(
...
Map<String, dynamic> _$DarwinCorePlotToJson(_DarwinCorePlot instance) => <String, dynamic>{
  'id': instance.id,
