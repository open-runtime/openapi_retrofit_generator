...
_DarwinCoreOccurrence _$DarwinCoreOccurrenceFromJson(Map<String, dynamic> json) => _DarwinCoreOccurrence(
...
Map<String, dynamic> _$DarwinCoreOccurrenceToJson(_DarwinCoreOccurrence instance) => <String, dynamic>{
  'id': instance.id,
