...
_OtherResults _$OtherResultsFromJson(Map<String, dynamic> json) => _OtherResults(
...
Map<String, dynamic> _$OtherResultsToJson(_OtherResults instance) => <String, dynamic>{
