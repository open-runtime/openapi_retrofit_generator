...
_DarwinCorePlots _$DarwinCorePlotsFromJson(Map<String, dynamic> json) => _DarwinCorePlots(
...
Map<String, dynamic> _$DarwinCorePlotsToJson(_DarwinCorePlots instance) => <String, dynamic>{
