...
_$AssistantMessageErrorUnionProviderAuthErrorFromJson(
...
_$AssistantMessageErrorUnionUnknownErrorFromJson(Map<String, dynamic> json) =>
    AssistantMessageErrorUnionUnknownError(
      name: json['name'] as String,
...
Map<String, dynamic> _$AssistantMessageErrorUnionUnknownErrorToJson(
  AssistantMessageErrorUnionUnknownError instance,
) => <String, dynamic>{
  'name': instance.name,
...
_$AssistantMessageErrorUnionMessageOutputLengthErrorFromJson(
  Map<String, dynamic> json,
) => AssistantMessageErrorUnionMessageOutputLengthError(
  name: json['name'] as String,
  data: json['data'],
...
_$AssistantMessageErrorUnionMessageAbortedErrorFromJson(
  Map<String, dynamic> json,
) => AssistantMessageErrorUnionMessageAbortedError(
  name: json['name'] as String,
