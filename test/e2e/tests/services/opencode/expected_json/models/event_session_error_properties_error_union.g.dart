...
_$EventSessionErrorPropertiesErrorUnionProviderAuthErrorFromJson(
...
Map<String, dynamic>
_$EventSessionErrorPropertiesErrorUnionProviderAuthErrorToJson(
...
_$EventSessionErrorPropertiesErrorUnionUnknownErrorFromJson(
  Map<String, dynamic> json,
) => EventSessionErrorPropertiesErrorUnionUnknownError(
  name: json['name'] as String,
...
_$EventSessionErrorPropertiesErrorUnionMessageAbortedErrorFromJson(
  Map<String, dynamic> json,
) => EventSessionErrorPropertiesErrorUnionMessageAbortedError(
  name: json['name'] as String,
...
Map<String, dynamic>
_$EventSessionErrorPropertiesErrorUnionMessageAbortedErrorToJson(
