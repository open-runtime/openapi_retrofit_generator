...
class EventSessionErrorPropertiesErrorUnionProviderAuthError {
  ...
  factory EventSessionErrorPropertiesErrorUnionProviderAuthError.fromJson(Map<String, Object?> json) =>
      _$EventSessionErrorPropertiesErrorUnionProviderAuthErrorFromJson(json);

  Map<String, Object?> toJson() => _$EventSessionErrorPropertiesErrorUnionProviderAuthErrorToJson(this);
}
...
class EventSessionErrorPropertiesErrorUnionUnknownError {
  ...
  factory EventSessionErrorPropertiesErrorUnionUnknownError.fromJson(Map<String, Object?> json) =>
      _$EventSessionErrorPropertiesErrorUnionUnknownErrorFromJson(json);

  Map<String, Object?> toJson() => _$EventSessionErrorPropertiesErrorUnionUnknownErrorToJson(this);
}
...
class EventSessionErrorPropertiesErrorUnionMessageOutputLengthError {
  ...
  factory EventSessionErrorPropertiesErrorUnionMessageOutputLengthError.fromJson(Map<String, Object?> json) =>
      _$EventSessionErrorPropertiesErrorUnionMessageOutputLengthErrorFromJson(json);

  Map<String, Object?> toJson() => _$EventSessionErrorPropertiesErrorUnionMessageOutputLengthErrorToJson(this);
}
...
class EventSessionErrorPropertiesErrorUnionMessageAbortedError {
  ...
  factory EventSessionErrorPropertiesErrorUnionMessageAbortedError.fromJson(Map<String, Object?> json) =>
      _$EventSessionErrorPropertiesErrorUnionMessageAbortedErrorFromJson(json);

  Map<String, Object?> toJson() => _$EventSessionErrorPropertiesErrorUnionMessageAbortedErrorToJson(this);
}
