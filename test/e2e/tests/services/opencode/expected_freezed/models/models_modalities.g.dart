...
_ModelsModalities _$ModelsModalitiesFromJson(Map<String, dynamic> json) => _ModelsModalities(
...
Map<String, dynamic> _$ModelsModalitiesToJson(_ModelsModalities instance) => <String, dynamic>{
