...
@JsonKey(name: 'small_model') String? get smallModel;/// Custom username to display in conversations instead of system username
 ...
 Map<String, McpUnion>? get mcp; Map<String, Formatter>? get formatter; Map<String, LspUnion>? get lsp;/// Additional instruction files or patterns to include
...
as Map<String, McpUnion>?,formatter: freezed == formatter ? _self.formatter : formatter // ignore: cast_nullable_to_non_nullable
as Map<String, Formatter>?,lsp: freezed == lsp ? _self.lsp : lsp // ignore: cast_nullable_to_non_nullable
as Map<String, LspUnion>?,instructions: freezed == instructions ? _self.instructions : instructions // ignore: cast_nullable_to_non_nullable
...
/// MCP (Model Context Protocol) server configurations
 final  Map<String, McpUnion>? _mcp;
/// MCP (Model Context Protocol) server configurations
@override Map<String, McpUnion>? get mcp {
  final value = _mcp;
  if (value == null) return null;
...
@override Map<String, Formatter>? get formatter {
 ...
 final  Map<String, LspUnion>? _lsp;
@override Map<String, LspUnion>? get lsp {
  final value = _lsp;
  if (value == null) return null;
...
as Map<String, McpUnion>?,formatter: freezed == formatter ? _self._formatter : formatter // ignore: cast_nullable_to_non_nullable
as Map<String, Formatter>?,lsp: freezed == lsp ? _self._lsp : lsp // ignore: cast_nullable_to_non_nullable
as Map<String, LspUnion>?,instructions: freezed == instructions ? _self._instructions : instructions // ignore: cast_nullable_to_non_nullable
as List<String>?,layout: freezed == layout ? _self.layout : layout // ignore: cast_nullable_to_non_nullable
as LayoutConfig?,configPermission: freezed == configPermission ? _self.configPermission : configPermission // ignore: cast_nullable_to_non_nullable
