...
Map<String, dynamic> _$LspUnionVariant1ToJson(LspUnionVariant1 instance) =>
    <String, dynamic>{'disabled': instance.disabled};

LspUnionVariant2 _$LspUnionVariant2FromJson(Map<String, dynamic> json) =>
    LspUnionVariant2(
...
Map<String, dynamic> _$LspUnionVariant2ToJson(LspUnionVariant2 instance) =>
    <String, dynamic>{
