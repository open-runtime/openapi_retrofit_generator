...
class MessageUnionUserMessage {
  ...
  factory MessageUnionUserMessage.fromJson(Map<String, Object?> json) => _$MessageUnionUserMessageFromJson(json);

  Map<String, Object?> toJson() => _$MessageUnionUserMessageToJson(this);
}
...
class MessageUnionAssistantMessage {
  ...
  factory MessageUnionAssistantMessage.fromJson(Map<String, Object?> json) =>
      _$MessageUnionAssistantMessageFromJson(json);

  Map<String, Object?> toJson() => _$MessageUnionAssistantMessageToJson(this);
}
