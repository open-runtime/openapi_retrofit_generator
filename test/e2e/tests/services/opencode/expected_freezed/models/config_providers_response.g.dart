...
_ConfigProvidersResponse _$ConfigProvidersResponseFromJson(Map<String, dynamic> json) => _ConfigProvidersResponse(
...
Map<String, dynamic> _$ConfigProvidersResponseToJson(_ConfigProvidersResponse instance) => <String, dynamic>{
