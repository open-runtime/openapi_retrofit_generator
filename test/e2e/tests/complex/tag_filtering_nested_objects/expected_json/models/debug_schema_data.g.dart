...
DebugSchemaData _$DebugSchemaDataFromJson(Map<String, dynamic> json) => DebugSchemaData(
...
Map<String, dynamic> _$DebugSchemaDataToJson(DebugSchemaData instance) => <String, dynamic>{
  'name': ?instance.name,
  'id': ?instance.id,
