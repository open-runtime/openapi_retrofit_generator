...
class AddressMapper extends ClassMapperBase<Address> {
  ...
  static const Field<Address, String> _f$street = Field(
    'street',
    _$street,
    opt: true,
  );
  static bool? _$deleted(Address v) => v.deleted;
  static const Field<Address, bool> _f$deleted = Field(
    'deleted',
    _$deleted,
    opt: true,
  );
  ...
  static Address _instantiate(DecodingData data) {
    return Address(street: data.dec(_f$street), deleted: data.dec(_f$deleted));
  }
...
abstract class AddressCopyWith<$R, $In extends Address, $Out>
  ...
  $R call({String? street, bool? deleted});
...
class _AddressCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({Object? street = $none, Object? deleted = $none}) => $apply(
    FieldCopyWithData({
