...
class FamilyMembersUnionMapper extends ClassMapperBase<FamilyMembersUnion> {
  ...
  static FamilyMembersUnionMapper ensureInitialized() {
    if (_instance == null) {
      ...
      FamilyMembersUnionUnknownMapper.ensureInitialized();
    }
    return _instance!;
  }
...
class FamilyMembersUnionUnknownMapper
    extends SubClassMapperBase<FamilyMembersUnionUnknown> {
  FamilyMembersUnionUnknownMapper._();

  static FamilyMembersUnionUnknownMapper? _instance;
  static FamilyMembersUnionUnknownMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = FamilyMembersUnionUnknownMapper._(),
      );
      FamilyMembersUnionMapper.ensureInitialized().addSubMapper(_instance!);
    }
    return _instance!;
  ...
  @override
  final String id = 'FamilyMembersUnionUnknown';

  static Map<String, dynamic> _$json(FamilyMembersUnionUnknown v) => v.json;
  static const Field<FamilyMembersUnionUnknown, Map<String, dynamic>> _f$json =
      Field('json', _$json);

  @override
  final MappableFields<FamilyMembersUnionUnknown> fields = const {
    #json: _f$json,
  };
  ...
  static FamilyMembersUnionUnknown _instantiate(DecodingData data) {
    return FamilyMembersUnionUnknown(data.dec(_f$json));
  }

  @override
  final Function instantiate = _instantiate;

  static FamilyMembersUnionUnknown fromJson(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<FamilyMembersUnionUnknown>(map);
  }

  static FamilyMembersUnionUnknown fromJsonString(String json) {
    return ensureInitialized().decodeJson<FamilyMembersUnionUnknown>(json);
  }
}

mixin FamilyMembersUnionUnknownMappable {
  String toJsonString() {
    return FamilyMembersUnionUnknownMapper.ensureInitialized()
        .encodeJson<FamilyMembersUnionUnknown>(
          this as FamilyMembersUnionUnknown,
        );
  }

  Map<String, dynamic> toJson() {
    return FamilyMembersUnionUnknownMapper.ensureInitialized()
        .encodeMap<FamilyMembersUnionUnknown>(
          this as FamilyMembersUnionUnknown,
        );
  }

  FamilyMembersUnionUnknownCopyWith<
    FamilyMembersUnionUnknown,
    FamilyMembersUnionUnknown,
    FamilyMembersUnionUnknown
  >
  get copyWith =>
      _FamilyMembersUnionUnknownCopyWithImpl<
        FamilyMembersUnionUnknown,
        FamilyMembersUnionUnknown
      >(this as FamilyMembersUnionUnknown, $identity, $identity);
  @override
  String toString() {
    return FamilyMembersUnionUnknownMapper.ensureInitialized().stringifyValue(
      this as FamilyMembersUnionUnknown,
    );
  }
  ...
  @override
  bool operator ==(Object other) {
    return FamilyMembersUnionUnknownMapper.ensureInitialized().equalsValue(
      this as FamilyMembersUnionUnknown,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return FamilyMembersUnionUnknownMapper.ensureInitialized().hashValue(
      this as FamilyMembersUnionUnknown,
    );
  }
}

extension FamilyMembersUnionUnknownValueCopy<$R, $Out>
    on ObjectCopyWith<$R, FamilyMembersUnionUnknown, $Out> {
  FamilyMembersUnionUnknownCopyWith<$R, FamilyMembersUnionUnknown, $Out>
  get $asFamilyMembersUnionUnknown => $base.as(
    (v, t, t2) => _FamilyMembersUnionUnknownCopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class FamilyMembersUnionUnknownCopyWith<
  $R,
  $In extends FamilyMembersUnionUnknown,
  $Out
>
    implements FamilyMembersUnionCopyWith<$R, $In, $Out> {
  ...
  FamilyMembersUnionUnknownCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  );
}

class _FamilyMembersUnionUnknownCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, FamilyMembersUnionUnknown, $Out>
    implements
        FamilyMembersUnionUnknownCopyWith<$R, FamilyMembersUnionUnknown, $Out> {
  _FamilyMembersUnionUnknownCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<FamilyMembersUnionUnknown> $mapper =
      FamilyMembersUnionUnknownMapper.ensureInitialized();
  @override
  MapCopyWith<$R, String, dynamic, ObjectCopyWith<$R, dynamic, dynamic>>
  ...
  @override
  FamilyMembersUnionUnknown $make(CopyWithData data) =>
      FamilyMembersUnionUnknown(data.get(#json, or: $value.json));

  @override
  FamilyMembersUnionUnknownCopyWith<$R2, FamilyMembersUnionUnknown, $Out2>
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _FamilyMembersUnionUnknownCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
