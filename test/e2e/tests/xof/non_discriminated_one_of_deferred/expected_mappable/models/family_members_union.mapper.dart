...
class FamilyMembersUnionHumanMapper
    extends ClassMapperBase<FamilyMembersUnionHuman> {
  ...
  @override
  final MappableFields<FamilyMembersUnionHuman> fields = const {#job: _f$job};

  static FamilyMembersUnionHuman _instantiate(DecodingData data) {
    return FamilyMembersUnionHuman(job: data.dec(_f$job));
  }
...
class _FamilyMembersUnionHumanCopyWithImpl<$R, $Out>
  ...
  @override
  FamilyMembersUnionHuman $make(CopyWithData data) =>
      FamilyMembersUnionHuman(job: data.get(#job, or: $value.job));
