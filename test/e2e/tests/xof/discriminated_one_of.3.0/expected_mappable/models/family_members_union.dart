...
@MappableClass(
  ...
  includeSubClasses: [FamilyMembersUnionCat, FamilyMembersUnionDog, FamilyMembersUnionHuman],
)
...
extension FamilyMembersUnionDeserializer on FamilyMembersUnion {
  static FamilyMembersUnion tryDeserialize(
    ...
    return switch (value) {
      ...
      _ => throw FormatException('Unknown discriminator value "${json[key]}" for FamilyMembersUnion'),
    };
  }
}
